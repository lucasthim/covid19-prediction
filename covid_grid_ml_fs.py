...
from cor_util import do_scaler, test_model,plot_confusion_matrix,to_geojson
...
program_name = "cor_grid_ml_fs.py"

model_number = 1 # 0:LR  1:RF 2:ADAB  3:XGB  4:LGB
...
mfs = LogisticRegression(penalty='l2', solver='liblinear')
...
erro = data_test[data_test['predict'] != data_test['Event']]
erro.to_csv(model_name + '_test_data_errors.csv')
erro.to_excel(model_name + '_test_data_errors.xls')

#Save to GEOJSON
to_geojson(erro,model_name)
